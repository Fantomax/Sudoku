...
//  зануление
    ...
    for (var i = 0; i < mass.length; i++) {
        var randomLength = Math.round(Math.random()*4 + 3);
...
function reshenie(decision){
    ...
    function some(row, coll) {
        var sm = [];
//        var found = 0,
//            res = [];
//        found = field.indexOf(x, found);
//        while (found >= 0) {
//            res.push({
//                y: found / 9 >> 0,
//                x: found % 9
//            });
//            found = field.indexOf(x, found + 1);
//
//        }
    ...
    for(var o = 0; o < 10; o++){
        ...
        function buildMassOfDec (lengthMath) {
                ...
                for(var coll = 0; coll < decision[row].length; coll++){
                    ...
                    if (decision[row][coll] == 0) {
                        ...
                        for(var k = 0; k < decision.length; k++){
                            if (decision[row].indexOf(k+1) < 0 && deccoll(coll).indexOf(k+1) < 0 && some(row, coll).indexOf(k+1) < 0) {
